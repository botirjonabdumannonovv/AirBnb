...
namespace AirBnb.ServerApp.Infrastructure.Common.Locations.Caching;

public class RedisDistributedCacheService(IOptions<CacheSettings> cacheSettings, IDistributedCache distributedCache) : ICacheBroker
{
