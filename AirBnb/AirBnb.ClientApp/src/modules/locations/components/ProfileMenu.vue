<template>
  ...
  <div class="hidden md:flex flex-2 justify-center items-center gap-5">
    ...
    <button class="flex px-2 justify-center items-center gap-2 rounded-full p-1 border border-gray-300">
      ...
      <span class="h-8 w-8 text-logoSecondary">
                <svg width="32px"
                     height="32px"
                     class="h-8 w-8"
                     xmlns="http://www.w3.org/2000/svg"
