...
namespace AirBnb.ServerApp.Domain.Comparers;

public class OrderExpressionComparer<TSource> : IComparer<(Expression<Func<TSource, object>> KeySelector, bool IsAscending)>
{
    public int Compare((Expression<Func<TSource, object>> KeySelector, bool IsAscending) x, (Expression<Func<TSource, object>> KeySelector, bool IsAscending) y)
    {
        ...
        var keySelectorComparison =
            string.Compare(x.KeySelector.ToString(), y.KeySelector.ToString(), StringComparison.Ordinal);
