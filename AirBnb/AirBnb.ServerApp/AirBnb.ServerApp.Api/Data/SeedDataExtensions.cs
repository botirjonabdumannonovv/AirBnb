...
public static class SeedDataExtensions
{
    ...
    {
        var locationsDbContext = serviceProvider.GetRequiredService<AppDbContext>();
    ...
    private static async ValueTask SeedLocationsAsync(this AppDbContext airBnBdbContext)
    {
    ...
    private static async ValueTask SeedLocationCategoryAsync(this AppDbContext airBnBdbContext, IWebHostEnvironment environment)
    {
